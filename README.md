При запуске из командной строки нужно передать название файла с фигурой в формате Circle345.txt вторым параметром (после названия исполняемого файла). Названия фигур начинаются с Circke,Rect,Bug
